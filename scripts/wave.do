...
add wave -noupdate -expand -group {Core0 CCsigs} /system_tb/DUT/CPU/CM0/DCACHE/link_address
add wave -noupdate -expand -group {Core0 CCsigs} /system_tb/DUT/CPU/CM0/DCACHE/link_valid
add wave -noupdate -expand -group {Core0 CCsigs} /system_tb/DUT/CPU/CM0/DCACHE/atomic_hit
...
WaveRestoreCursors {{Cursor 1} {1600000 ps} 0} {{Cursor 2} {4596778 ps} 0}
...
update
WaveRestoreZoom {1525925 ps} {1704925 ps}
